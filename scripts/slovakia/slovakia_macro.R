...
#====================================================
# 2. Plot the level of support for each question
#====================================================
...
box_plot <- ggplot(box_data_long, aes(x = Question, y = Support, fill = Question)) +
  ...
  # Labels
  labs(
    title = "Slovakia: Standardized Support by Question",
...
ggsave(
  filename = "~/projects/AaD_Research/output/plots/slovakia/dist/slovakia_macro.pdf",
  plot = box_plot,
